          ...
          <Col lg={6}>
            <Card className={'iq-card'}>
              ...
              <CardBody className={'iq-card-body'}>
                <CardText>
                  In addition, as pages likely have more than one such
                  navigation section, it’s advisable to provide a descriptive{' '}
                  <code>aria-label</code> for the <code>&lt;nav&gt;</code> to
                  reflect its purpose. For example, if the pagination component
            ...
            <Card className={'iq-card'}>
              ...
              <CardBody className={'iq-card-body'}>
                <CardText>
                  ...
                  and <code>.active</code> to indicate the current page. While
                  the <code>.disabled</code> class uses{' '}
                  <code>pointer-events: none</code> to <em>try</em> to disable
                  the link functionality of <code>&lt;a&gt;</code>s, that CSS
                  property is not yet standardized and doesn’t account for
...
<Pagination.Item><a href="!#">{"Next"}</a></Pagination.Item>
                ...
                <p>
                  ...
                  <code>&lt;span&gt;</code>, or omit the anchor in the case of
                  the prev/next arrows, to remove click functionality and
