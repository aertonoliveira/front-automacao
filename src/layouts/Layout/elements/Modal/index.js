...
<Modal isOpen={this.state.model1} toggle={ () => this.toggle("model1") }>
    ...
    <ModalFooter>
        ...
        <Button color="secondary" onClick={ () => this.toggle("model1") }>Cancel</Button>
                ...
                {/*Button trigger modal*/}
                <Button color="primary" onClick={() => this.toggle('model1')}>
                  {' '}
                  Launch demo modal{' '}
                </Button>
                ...
                {/*Modal*/}
                <Modal
                  isOpen={this.state.model1}
                  toggle={() => this.toggle('model1')}
                >
                  <ModalHeader toggle={() => this.toggle('model1')}>
                    Modal title
                  </ModalHeader>
                  <ModalBody>...</ModalBody>
                  <ModalFooter>
...
<Modal isOpen={this.state.model2} toggle={ () => this.toggle("model2") } className="modal-dialog-scrollable">
    ...
    <ModalFooter>
        ...
        <Button color="secondary" onClick={ () => this.toggle("model2") }>Cancel</Button>
                ...
                {/*Button trigger modal*/}
                <Button color="primary" onClick={() => this.toggle('model2')}>
                  {' '}
                  Launch demo modal{' '}
                </Button>
                ...
                <Modal
                  ...
                  toggle={() => this.toggle('model2')}
                  className="modal-dialog-scrollable"
                >
                  <ModalHeader toggle={() => this.toggle('model2')}>
                    Modal title
                  </ModalHeader>
                  <ModalBody>
                    <p>
...
<Modal isOpen={this.state.model5} toggle={ () => this.toggle("model5") } className="modal-sm">
    ...
    <ModalFooter>
        ...
        <Button color="secondary" onClick={ () => this.toggle("model5") }>Cancel</Button>
                ...
                {/*Extra large modal*/}
                <Button color="primary" onClick={() => this.toggle('model3')}>
                  {' '}
                  Extra large modal{' '}
                </Button>{' '}
                {/*Modal*/}
                <Modal
                  isOpen={this.state.model3}
                  toggle={() => this.toggle('model3')}
                  className="modal-xl"
                >
                  <ModalHeader toggle={() => this.toggle('model3')}>
                    Modal title
                  </ModalHeader>
                  <ModalBody>
                    <p>Modal body text goes here.</p>
                ...
                {/*Large modal*/}
                <Button color="primary" onClick={() => this.toggle('model4')}>
                  {' '}
                  Large modal{' '}
                </Button>{' '}
                {/*Modal*/}
                <Modal
                  isOpen={this.state.model4}
                  toggle={() => this.toggle('model4')}
                  className="modal-lg"
                >
                  <ModalHeader toggle={() => this.toggle('model4')}>
                    Modal title
                  </ModalHeader>
                  <ModalBody>
                    <p>Modal body text goes here.</p>
                ...
                {/*Small modal*/}
                <Button color="primary" onClick={() => this.toggle('model5')}>
                  {' '}
                  Small modal{' '}
                </Button>{' '}
                {/*Modal*/}
                <Modal
                  isOpen={this.state.model5}
                  toggle={() => this.toggle('model5')}
                  className="modal-sm"
                >
                  <ModalHeader toggle={() => this.toggle('model5')}>
                    Modal title
                  </ModalHeader>
                  <ModalBody>
                    <p>Modal body text goes here.</p>
...
<Modal isOpen={this.state.model6} toggle={ () => this.toggle("model6") }>
    ...
    <ModalFooter>
        ...
        <Button color="secondary" onClick={ () => this.toggle("model6") }>Cancel</Button>
                ...
                {/*Button trigger modal*/}
                <Button color="primary" onClick={() => this.toggle('model6')}>
                  {' '}
                  Launch demo modal{' '}
                </Button>{' '}
                {/*Modal*/}
                <Modal
                  isOpen={this.state.model6}
                  toggle={() => this.toggle('model6')}
                >
                  <ModalHeader toggle={() => this.toggle('model6')}>
                    Modal title
                  </ModalHeader>
                  <ModalBody>
                    <p>
...
<Modal isOpen={this.state.model8} toggle={ () => this.toggle("model8") } className="modal-dialog-scrollable modal-dialog-centered">
    ...
    <ModalFooter>
        ...
        <Button color="secondary" onClick={ () => this.toggle("model8") }>Cancel</Button>
                ...
                {/*Button trigger modal*/}
                <Button color="primary" onClick={() => this.toggle('model7')}>
                  {' '}
                  Launch demo modal{' '}
                </Button>{' '}
                {/*Modal*/}
                <Modal
                  isOpen={this.state.model7}
                  toggle={() => this.toggle('model7')}
                  className="modal-dialog-centered"
                >
                  <ModalHeader toggle={() => this.toggle('model7')}>
                    Modal title
                  </ModalHeader>
                  <ModalBody>...</ModalBody>
                  <ModalFooter>
                ...
                {/*Button trigger modal*/}
                <Button color="primary" onClick={() => this.toggle('model8')}>
                  {' '}
                  Vertically centered scrollable modal{' '}
                </Button>{' '}
                {/*Modal*/}
                <Modal
                  isOpen={this.state.model8}
                  toggle={() => this.toggle('model8')}
                  className="modal-dialog-scrollable modal-dialog-centered"
                >
                  <ModalHeader toggle={() => this.toggle('model8')}>
                    Modal title
                  </ModalHeader>
                  <ModalBody>
                    <p>
...
<Modal isOpen={this.state.model9} toggle={ () => this.toggle("model9") }>
    ...
    <ModalFooter>
        ...
        <Button color="secondary" onClick={ () => this.toggle("model9") }>Cancel</Button>
                ...
                <Button color="primary" onClick={() => this.toggle('model9')}>
                  {' '}
                  Launch demo modal{' '}
                </Button>{' '}
                {/*Modal*/}
                <Modal
                  isOpen={this.state.model9}
                  toggle={() => this.toggle('model9')}
                >
                  <ModalHeader toggle={() => this.toggle('model9')}>
                    Modal title
                  </ModalHeader>
                  <ModalBody>
                    <div className="iq-example-row">
