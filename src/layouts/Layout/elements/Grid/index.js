                ...
                <Row className="iq-example-row">
                  <Container fluid={true}>
                    <Row className="mb-3">
                      ...
                      <Col className="col-6">2 of 3 (wider)</Col>
                      <Col className="col">3 of 3</Col>
                    </Row>
                    <Row>
                      <Col className="col">1 of 3</Col>
                      <Col className="col-5">2 of 3 (wider)</Col>
                      <Col className="col">3 of 3</Col>
                    </Row>
                  </Container>
                </Row>
...
One of three columns
                ...
                <Row className="iq-example-row iq-example-row-flex-cols">
                  <Container fluid={true}>
                    <Row className="align-items-start">
                      <Col className="col">One of three columns</Col>
                      <Col className="col">One of three columns</Col>
                      <Col className="col">One of three columns</Col>
                    </Row>
                    <Row className="align-items-center">
...
One of two columns
                ...
                <Row className="iq-example-row">
                  <Container fluid={true}>
                    <Row className="justify-content-start mb-3">
                      <Col className="col-4">One of two columns</Col>
                      <Col className="col-4">One of two columns</Col>
                    </Row>
                    <Row className="justify-content-center mb-3">
                      <Col className="col-4">One of two columns</Col>
