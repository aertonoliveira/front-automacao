            ...
            <Card className={'iq-card'}>
              ...
              <CardBody className={'iq-card-body'}>
                <CardText>
                  ...
                  to make it <em>appear</em> disabled. Note that some elements
                  with <code>.disabled</code> will also require custom
            ...
            <Card className={'iq-card'}>
              ...
              <CardBody className={'iq-card-body'}>
                <CardText>
                  ...
                  to remove some borders and rounded corners to render list
...
className="badge badge-danger badge-pill">1</Badge></ListGroup.Item>
                ...
                <ListGroup>
                  <ListGroup.Item variant={'primary'}>
                    Cras justo odio{' '}
                    <Badge className="badge badge-primary badge-pill">14</Badge>
                  </ListGroup.Item>
                  <ListGroup.Item variant={'success'}>
                    {' '}
                    Dapibus ac facilisis in
                    <Badge className="badge badge-success badge-pill">2</Badge>
                  </ListGroup.Item>
                  <ListGroup.Item variant={'danger'}>
                    Morbi leo risus{' '}
                    <Badge className="badge badge-danger badge-pill">1</Badge>
                  </ListGroup.Item>
                </ListGroup>
              </CardBody>
            </Card>
...
<ListGroup.Item>horizontally!</ListGroup.Item>
            ...
            <Card className={'iq-card'}>
              <div className={'iq-card-header d-flex justify-content-between'}>
                <CardTitle className={'card-title'}>
                  <h4>Contextual classes Action</h4>
                </CardTitle>
