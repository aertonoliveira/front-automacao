        ...
        <Row>
          <Col sm={3}>
            <Card className="card iq-mb-3">
              <img
                src={require('../../../../assets/images/page-img/07.jpg')}
          ...
          <Col sm={6}>
            <Card className="card iq-mb-3">
              <CardBody>
                ...
                <Button href="!#" color={'primary'} className="btn-block">
                  Go somewhere
                </Button>
              </CardBody>
            </Card>
                ...
                <Col md={8}>
                  <CardBody className="card-body">
                    ...
                    <CardText className="card-text">
                      ...
                      natural lead-in. a little bit longer.
                    </CardText>
                    <CardText className="card-text">
          ...
          <Col lg={4}>
            <Card className="iq-mb-3" outline color={'primary'}>
              <CardBody className="text-primary">
                <CardTitle>
                  <h4 className="text-primary">Primary card title</h4>
                </CardTitle>
                <CardText className="card-text">
                  Some quick example text to build on the card title text to
        ...
        <Row>
          ...
          <Col sm={12} className="col-sm-12">
            ...
            <CardColumns>
              ...
              <Card
                className="text-white text-center iq-mb-3"
                color={'primary'}
              >
                <blockquote className="blockquote mb-0 card-body">
                  <p className="font-size-14">
