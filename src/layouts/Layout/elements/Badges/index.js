...
<h6 className="mb-0">Example heading<Badge color="info">New</Badge></h6>
                ...
                <h4 className="mb-3">
                  Example heading <Badge color="danger">New</Badge>
                </h4>
                <h5 className="mb-3">
                  Example heading <Badge color="warning">New</Badge>
                </h5>
                <h6 className="mb-0">
...
Notifications <Badge  color="danger" className="ml-2">4</Badge>
                ...
                <Button
                  outline
                  color="primary"
                  className="mb-1 btn-outline-primary"
                >
                  Notifications{' '}
                ...
                <Button
                  outline
                  color="success"
                  className="mb-1 btn-outline-success"
                >
                  Notifications{' '}
                ...
                <Button
                  outline
                  color="danger"
                  className="mb-1 btn-outline-danger"
                >
                  Notifications{' '}
            ...
            <Card className={'iq-card'}>
              <div className={'iq-card-header d-flex justify-content-between'}>
                <CardTitle className={'card-title'}>
                  <h4>Button Light background Badges</h4>
                </CardTitle>
...
<a href="!#" className="badge badge-dark">Dark</a>{' '}
            ...
            <Card className={'iq-card'}>
              <div className={'iq-card-header d-flex justify-content-between'}>
                <CardTitle className={'card-title'}>
                  <h4>Contextual variations Border</h4>
                </CardTitle>
...
<a href="!#" className={"badge border border-dark text-dark"} >Dark</a>
                ...
                <span className={'badge border border-light text-light'}>
                  Light
                </span>{' '}
                ...
                <span
                  className={
                    'badge badge-pill border border-primary text-primary '
                  }
                >
                  Primary
                </span>{' '}
                <span
                  className={
                    'badge badge-pill border border-secondary text-secondary'
                  }
                >
                  Secondary
                </span>{' '}
                <span
                  className={
                    'badge badge-pill border border-success text-success'
                  }
                >
                  Success
                </span>{' '}
                <span
                  className={
                    'badge badge-pill border border-danger text-danger'
                  }
                >
                  Danger
                </span>{' '}
                <span
                  className={
                    'badge badge-pill border border-warning text-warning'
                  }
                >
                  Warning
                </span>{' '}
                <span
                  className={'badge badge-pill border border-info text-info'}
                >
                  Info
                </span>{' '}
                <span
                  className={'badge badge-pill border border-light text-light'}
                >
                  Light
                </span>{' '}
                <span
                  className={'badge badge-pill border border-dark text-dark'}
                >
                  Dark
                </span>
                <h5 className="card-title mt-4">Links</h5>
                ...
                <a href={'!#'} className={'badge border border-info text-info'}>
                  Info
                </a>{' '}
                <a
                  href={'!#'}
                  className={'badge border border-light text-light'}
                >
                  Light
                </a>{' '}
                <a href={'!#'} className={'badge border border-dark text-dark'}>
                  Dark
                </a>
              </CardBody>
            </Card>
