...
<p className="iq-bg-dark pl-3 pr-3 pt-2 pb-2 rounded mb-0">Dark link</p>
                ...
                <p className="iq-bg-primary pl-3 pr-3 pt-2 pb-2 rounded">
                  Primary link
                </p>
                <p className="iq-bg-secondary pl-3 pr-3 pt-2 pb-2 rounded">
                  Secondary link
                </p>
                <p className="iq-bg-success pl-3 pr-3 pt-2 pb-2 rounded">
                  Success link
                </p>
                <p className="iq-bg-danger pl-3 pr-3 pt-2 pb-2 rounded">
                  Danger link
                </p>
                <p className="iq-bg-warning pl-3 pr-3 pt-2 pb-2 rounded">
                  Warning link
                </p>
                <p className="iq-bg-info pl-3 pr-3 pt-2 pb-2 rounded">
                  Info link
                </p>
                <p className="iq-bg-dark pl-3 pr-3 pt-2 pb-2 rounded mb-0">
                  Dark link
                </p>
              </CardBody>
            </Card>
...
<p className="mb-0">
    <a className="iq-bg-dark pl-3 pr-3 pt-2 pb-2 rounded d-inline-block">Dark link</a>
                ...
                <p>
                  <a
                    href={'!#'}
                    className="iq-bg-primary pl-3 pr-3 pt-2 pb-2 rounded d-inline-block"
                  >
                    Primary link
                  </a>
                </p>
                <p>
                  <a
                    href={'!#'}
                    className="iq-bg-secondary pl-3 pr-3 pt-2 pb-2 rounded d-inline-block"
                  >
                    Secondary link
                  </a>
                </p>
                <p>
                  <a
                    href={'!#'}
                    className="iq-bg-success pl-3 pr-3 pt-2 pb-2 rounded d-inline-block"
                  >
                    Success link
                  </a>
                </p>
                <p>
                  <a
                    href={'!#'}
                    className="iq-bg-danger pl-3 pr-3 pt-2 pb-2 rounded d-inline-block"
                  >
                    Danger link
                  </a>
                </p>
                <p>
                  <a
                    href={'!#'}
                    className="iq-bg-warning pl-3 pr-3 pt-2 pb-2 rounded d-inline-block"
                  >
                    Warning link
                  </a>
                </p>
                <p>
                  <a
                    href={'!#'}
                    className="iq-bg-info pl-3 pr-3 pt-2 pb-2 rounded d-inline-block"
                  >
                    Info link
                  </a>
                </p>
                <p className="mb-0">
                  <a
                    href={'!#'}
                    className="iq-bg-dark pl-3 pr-3 pt-2 pb-2 rounded d-inline-block"
                  >
                    Dark link
                  </a>
                </p>
