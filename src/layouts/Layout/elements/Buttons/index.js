...
<Button color="link" className="mb-3">link</Button>
                ...
                <Button color="secondary" className="mb-3">
                  secondary
                </Button>{' '}
                ...
                <Button color="info" className="mb-3">
                  info
                </Button>{' '}
                ...
                <Button color="link" className="mb-3">
                  link
                </Button>
              </CardBody>
            </Card>
...
<Button color="link" className="rounded-pill mb-3">link</Button>
                ...
                <Button color="primary" className="rounded-pill mb-3">
                  primary
                </Button>{' '}
                <Button color="secondary" className="rounded-pill mb-3">
                  secondary
                </Button>{' '}
                <Button color="success" className="rounded-pill mb-3">
                  success
                </Button>{' '}
                <Button color="danger" className="rounded-pill mb-3">
                  danger
                </Button>{' '}
                <Button color="warning" className="rounded-pill mb-3">
                  warning
                </Button>{' '}
                <Button color="info" className="rounded-pill mb-3">
                  info
                </Button>{' '}
                <Button color="light" className="rounded-pill mb-3">
                  Light
                </Button>{' '}
                <Button color="dark" className="rounded-pill mb-3">
                  Dark
                </Button>{' '}
                <Button color="link" className="rounded-pill mb-3">
                  link
                </Button>
              </CardBody>
            </Card>
...
<Button  outline color="link" className="rounded-pill mb-3" >Link</Button>
                ...
                <Button outline color="primary" className="rounded-pill mb-3">
                  Primary
                </Button>
                <Button outline color="secondary" className="rounded-pill mb-3">
                  Secondary
                </Button>
                <Button outline color="success" className="rounded-pill mb-3">
                  Success
                </Button>
                <Button outline color="warning" className="rounded-pill mb-3">
                  Warning
                </Button>
                <Button outline color="danger" className="rounded-pill mb-3">
                  Danger
                </Button>
                <Button outline color="info" className="rounded-pill mb-3">
                  Info
                </Button>
                <Button outline color="light" className="rounded-pill mb-3">
                  Light
                </Button>
                <Button outline color="dark" className="rounded-pill mb-3">
                  Dark
                </Button>
                <Button outline color="link" className="rounded-pill mb-3">
                  Link
                </Button>
              </CardBody>
            </Card>
...
<Button color="link" className="mb-3"><i className="ri-bill-fill" /> link</Button>
                ...
                <Button color="primary" className="mb-3">
                  <i className="ri-bill-fill" /> primary
                </Button>{' '}
                <Button color="secondary" className="mb-3">
                  <i className="ri-heart-fill" /> secondary
                </Button>{' '}
                <Button color="success" className="mb-3">
                  <i className="ri-bill-fill" /> success
                </Button>{' '}
                <Button color="danger" className="mb-3">
                  <i className="ri-heart-fill" /> danger
                </Button>{' '}
                <Button color="warning" className="mb-3">
                  <i className="ri-bill-fill" /> warning
                </Button>{' '}
                <Button color="info" className="mb-3">
                  <i className="ri-heart-fill" /> info
                </Button>{' '}
                <Button color="light" className="mb-3">
                  <i className="ri-bill-fill" /> Light
                </Button>{' '}
                <Button color="dark" className="mb-3">
                  <i className="ri-heart-fill" /> Dark
                </Button>{' '}
                <Button color="link" className="mb-3">
                  <i className="ri-bill-fill" /> link
                </Button>
              </CardBody>
            </Card>
          </Col>
...
<Button outline color="link" className="mb-3"><i className="ri-alert-line" /> link</Button>
                ...
                <Button outline color="primary" className="mb-3">
                  <i className="ri-heart-line" /> primary
                </Button>{' '}
                <Button outline color="secondary" className="mb-3">
                  <i className="ri-alert-line" /> secondary
                </Button>{' '}
                <Button outline color="success" className="mb-3">
                  <i className="ri-heart-line" /> success
                </Button>{' '}
                <Button outline color="danger" className="mb-3">
                  <i className="ri-alert-line" /> danger
                </Button>{' '}
                <Button outline color="warning" className="mb-3">
                  <i className="ri-heart-line" /> warning
                </Button>{' '}
                <Button outline color="info" className="mb-3">
                  <i className="ri-alert-line" /> info
                </Button>{' '}
                <Button outline color="dark" className="mb-3">
                  <i className="ri-heart-line" /> dark
                </Button>{' '}
                <Button outline color="link" className="mb-3">
                  <i className="ri-alert-line" /> link
                </Button>
              </CardBody>
            </Card>
          </Col>
...
<Button outline color="link" className="mb-3 rounded-pill"><i className="ri-alert-line" /> link</Button>
                ...
                <Button outline color="primary" className="mb-3 rounded-pill">
                  <i className="ri-heart-line" /> primary
                </Button>{' '}
                <Button outline color="secondary" className="mb-3 rounded-pill">
                  <i className="ri-alert-line" /> secondary
                </Button>{' '}
                <Button outline color="success" className="mb-3 rounded-pill">
                  <i className="ri-heart-line" /> success
                </Button>{' '}
                <Button outline color="danger" className="mb-3 rounded-pill">
                  <i className="ri-alert-line" /> danger
                </Button>{' '}
                <Button outline color="warning" className="mb-3 rounded-pill">
                  <i className="ri-heart-line" /> warning
                </Button>{' '}
                <Button outline color="info" className="mb-3 rounded-pill">
                  <i className="ri-alert-line" /> info
                </Button>{' '}
                <Button outline color="dark" className="mb-3 rounded-pill">
                  <i className="ri-heart-line" /> dark
                </Button>{' '}
                <Button outline color="link" className="mb-3 rounded-pill">
                  <i className="ri-alert-line" /> link
                </Button>
              </CardBody>
            </Card>
...
<Button className="mb-3" color="primary"><i className="ri-lock-fill" /> Buttons</Button>
                ...
                <Button color="primary" className="mb-3">
                  <i className="ri-heart-fill pr-0" />{' '}
                </Button>{' '}
                <Button color="secondary" className="mb-3">
                  <i className="ri-star-fill pr-0" />{' '}
                </Button>{' '}
                <Button color="success" className="mb-3">
                  <i className="ri-settings-4-fill pr-0" />{' '}
                </Button>{' '}
                <Button color="danger" className="mb-3">
                  <i className="ri-radio-button-fill pr-0" />{' '}
                </Button>{' '}
                <Button color="warning" className="mb-3">
                  <i className="ri-delete-bin-2-fill pr-0" />{' '}
                </Button>{' '}
                <Button color="info" className="mb-3">
                  <i className="ri-lock-fill pr-0" />{' '}
                </Button>{' '}
                <Button color="light" className="mb-3">
                  <i className="ri-time-fill pr-0" />{' '}
                </Button>{' '}
                <Button color="dark" className="mb-3">
                  <i className="ri-sun-fill pr-0" />{' '}
                </Button>{' '}
                <Button color="link" className="mb-3">
                  <i className="ri-moon-fill pr-0" />{' '}
                </Button>
                <div className="d-inline-block w-100 mt-3">
                  <Button className="mb-3" color="primary">
                    <i className="ri-heart-fill" /> Buttons
                  </Button>{' '}
                  <Button className="mb-3" color="secondary">
                    <i className="ri-star-fill" /> Buttons
                  </Button>{' '}
                  <Button className="mb-3" color="success">
                    <i className="ri-settings-4-fill" /> Buttons
                  </Button>{' '}
                  <Button className="mb-3" color="danger">
                    <i className="ri-radio-button-fill" /> Buttons
                  </Button>{' '}
                  <Button className="mb-3" color="primary">
                    <i className="ri-lock-fill" /> Buttons
                  </Button>
                </div>
              </CardBody>
            </Card>
...
<Button className="mb-3" outline color ="primary" disabled>Disabled</Button>
                ...
                <Button className="mb-3" color="primary" active>
                  Active
                </Button>{' '}
                <Button className="mb-3" color="secondary" active>
                  Active
                </Button>{' '}
                <Button className="mb-3" color="warning" active>
                  Active
                </Button>{' '}
                <Button className="mb-3" color="accent" disabled>
                  Disabled
                </Button>{' '}
                <Button className="mb-3" color="primary" disabled>
                  Disabled
                </Button>{' '}
                <Button className="mb-3" outline color="primary" disabled>
                  Disabled
                </Button>
              </CardBody>
            </Card>
