              ...
              <CardBody className={'iq-card-body'}>
                ...
                <div className="custom-control custom-switch custom-switch-color custom-control-inline">
                  <Input
                    ...
                    defaultChecked
                  />
                  <Label className="custom-control-label" for="customSwitch01">
                    Primary
                  </Label>
                </div>
                <div className="custom-control custom-switch custom-switch-color custom-control-inline">
                  <Input
                    ...
                    defaultChecked
                  />
                  <Label className="custom-control-label" for="customSwitch02">
                    Success
                  </Label>
                </div>
                <div className="custom-control custom-switch custom-switch-color custom-control-inline">
                  <Input
                    ...
                    defaultChecked
                  />
                  <Label className="custom-control-label" for="customSwitch03">
                    Danger
                  </Label>
                </div>
                <div className="custom-control custom-switch custom-switch-color custom-control-inline">
                  <Input
                    type="checkbox"
                    className="custom-control-input bg-waring"
                    id="customSwitch04"
                    defaultChecked
                  />
                  <Label className="custom-control-label" for="customSwitch04">
                    Waring
                  </Label>
                </div>
                <div className="custom-control custom-switch custom-switch-color custom-control-inline">
                  <Input
                    ...
                    defaultChecked
                  />
                  <Label className="custom-control-label" for="customSwitch05">
                    Dark
                  </Label>
                </div>
                <div className="custom-control custom-switch custom-switch-color custom-control-inline">
                  <Input
                    ...
                    defaultChecked
                  />
                  <Label className="custom-control-label" for="customSwitch06">
                    Info
                  </Label>
                </div>
              </CardBody>
