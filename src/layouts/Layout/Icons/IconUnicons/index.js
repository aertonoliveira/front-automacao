          ...
          <Col sm={12}>
            <div className="iq-card">
              ...
              <div className="iq-card-body">
                <CardText>
                  Use Class{' '}
                  <code>&lt;i className="ion-archive"&gt;&lt;/i&gt;</code>
                </CardText>
                <Row className="mt-3">
                  <Col sm={6} md={4} lg={2}>
