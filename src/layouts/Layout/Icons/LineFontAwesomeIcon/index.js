            ...
            <div className="iq-card">
              ...
              <div className="iq-card-body">
                ...
                <Row className="mt-3">
                  ...
                  <Col sm={6} md={4} lg={2}>
                    <a className="iq-icons-list" href="!#">
                      <i className="las la-location-arrow" />
                      location-arrow
                    </a>
                  </Col>
                  <Col sm={6} md={4} lg={2}>
                  ...
                  <Col sm={6} md={4} lg={2}>
                    <a className="iq-icons-list" href="!#">
                      <i className="las la-volume-down" />
                      volume-down
                    </a>
                  </Col>
                  <Col sm={6} md={4} lg={2}>
