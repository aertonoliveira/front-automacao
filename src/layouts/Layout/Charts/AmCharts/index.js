                ...
                <UncontrolledCollapse toggler="#collapse1">
                  <Card>
                    <kbd className="bg-dark">
                      <span
                        data-copy-target="#am-simple-chart-code"
                        title="Copy"
                        data-toggle="tooltip"
              ...
              <CardBody className="iq-card-body">
                <UncontrolledCollapse toggler="#collapse2">
                  <Card>
                    <kbd className="bg-dark">
                      <span
                        data-copy-target="#am-layeredcolumn-chart-code"
                        title="Copy"
                        data-toggle="tooltip"
                        className="float-right"
                        data-copy="true"
              ...
              <CardBody className="iq-card-body">
                <UncontrolledCollapse toggler="#collapse3">
                  <Card>
                    <kbd className="bg-dark">
                      <span
                        data-copy-target="#am-barline-chart-code"
                        title="Copy"
                        data-toggle="tooltip"
                        className="float-right"
                        data-copy="true"
              ...
              <CardBody className="iq-card-body">
                <UncontrolledCollapse toggler="#collapse4">
                  <Card>
                    <kbd className="bg-dark">
                      <span
                        data-copy-target="#am-linescrollzomm-chart-code"
                        title="Copy"
                        data-toggle="tooltip"
                        className="float-right"
                        data-copy="true"
              ...
              <CardBody className="iq-card-body">
                <UncontrolledCollapse toggler="#collapse5">
                  <Card>
                    <kbd className="bg-dark">
                      <span
                        data-copy-target="#am-radar-chart-code"
                        title="Copy"
                        data-toggle="tooltip"
                        className="float-right"
                        data-copy="true"
              ...
              <CardBody className="iq-card-body">
                <UncontrolledCollapse toggler="#collapse6">
                  <Card>
                    <kbd className="bg-dark">
                      <span
                        data-copy-target="#am-polar-chart-code"
                        title="Copy"
                        data-toggle="tooltip"
                        className="float-right"
                        data-copy="true"
              ...
              <CardBody className="iq-card-body">
                <UncontrolledCollapse toggler="#collapse7">
                  <Card>
                    <kbd className="bg-dark">
                      <span
                        data-copy-target="#am-columnlinr-chart-code"
                        title="Copy"
                        data-toggle="tooltip"
                        className="float-right"
                        data-copy="true"
              ...
              <CardBody className="iq-card-body">
                <UncontrolledCollapse toggler="#collapse8">
                  <Card>
                    <kbd className="bg-dark">
                      <span
                        data-copy-target="#am-stackedcolumn-chart-code"
                        title="Copy"
                        data-toggle="tooltip"
                        className="float-right"
                        data-copy="true"
              ...
              <CardBody className="iq-card-body">
                <UncontrolledCollapse toggler="#collapse9">
                  <Card>
                    <kbd className="bg-dark">
                      <span
                        data-copy-target="#am-datedata-chart-code"
                        title="Copy"
                        data-toggle="tooltip"
                        className="float-right"
                        data-copy="true"
              ...
              <CardBody className="iq-card-body">
                <UncontrolledCollapse toggler="#collapse10">
                  <Card>
                    <kbd className="bg-dark">
                      <span
                        data-copy-target="#am-zoomable-chart-code"
                        title="Copy"
                        data-toggle="tooltip"
                        className="float-right"
                        data-copy="true"
              ...
              <CardBody className="iq-card-body">
                <UncontrolledCollapse toggler="#collapse11">
                  <Card>
                    <kbd className="bg-dark">
                      <span
                        data-copy-target="#am-polarscatter-chart-code"
                        title="Copy"
                        data-toggle="tooltip"
                        className="float-right"
                        data-copy="true"
              ...
              <CardBody className="iq-card-body">
                <UncontrolledCollapse toggler="#collapse12">
                  <Card>
                    <kbd className="bg-dark">
                      <span
                        data-copy-target="#am-3dpie-chart-code"
                        title="Copy"
                        data-toggle="tooltip"
                        className="float-right"
                        data-copy="true"
